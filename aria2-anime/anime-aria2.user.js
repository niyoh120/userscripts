...
// @require      https://cdn.jsdelivr.net/npm/jsoneditor@10.0.3
// @resource     jsoneditor/dist/jsoneditor.min.css  https://cdn.jsdelivr.net/npm/jsoneditor@10.0.3/dist/jsoneditor.min.css
// @grant        GM_addStyle
...
(function (JSONEditor) {
  ...
  var promiseEvent$1 = {};
  Object.defineProperty(promiseEvent$1, "__esModule", { value: true });
  ...
  promiseEvent$1.default = promiseEvent;
  var JSONRPCError$1 = {};
  Object.defineProperty(JSONRPCError$1, "__esModule", { value: true });
  ...
  JSONRPCError$1.default = JSONRPCError;
  ...
  Object.defineProperty(JSONRPCClient$1, "__esModule", { value: true });
  const events_1 = eventsExports;
  const ws_1 = browser$1;
  const Deferred_1 = Deferred$1;
  const promiseEvent_1 = promiseEvent$1;
  const JSONRPCError_1 = JSONRPCError$1;
  ...
  JSONRPCClient$1.default = JSONRPCClient;
  ...
  var Aria2RPC_1 = dist.Aria2RPC = void 0;
  const JSONRPCClient_1 = JSONRPCClient$1;
  function prefix(str) {
  ...
  Aria2RPC_1 = dist.Aria2RPC = Aria2RPC;
  ...
  async function getDownloadInfo(downloadPageURL) {
    ...
    await new Promise((resolve2) => iframe.onload = resolve2);
